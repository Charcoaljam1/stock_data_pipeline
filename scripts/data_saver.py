...
class BalanceSheet(Base):
    ...
    cash_and_cash_equivalents = Column(DECIMAL(15,2))
...
class IncomeStatement(Base):
    ...
    ebit_margin = Column(DECIMAL(5,2))
...
class CashFlow(Base):
    ...
    capital_expenditures = Column(DECIMAL(15,2))
    cash_from_investing = Column(DECIMAL(15,2))
    cash_from_financing = Column(DECIMAL(15,2))
    dividend_payments = Column(DECIMAL(15,2))
    debt_repayments = Column(DECIMAL(15,2))
